  ...
  <div class="row">
    <div class="col">
      <div class="card">
        ...
        <?php
          foreach ($list as $row) { ?>
          <H4>:: ข้อมูลเดือนล่าสุด :: <?php echo $row['o_month'] ?></H4>
        </div>
        <br>
                ...
                <div class="row">
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <h5 class="description-header"> <?php echo $row['o_sum_revenue'] ?></h5>
                  ...
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <h5 class="description-header"><?php echo $row['o_get_real'] ?></h5>
                  ...
                  <div class="col-sm-4">
                    <div class="description-block">
                      <h5 class="description-header"><?php echo $row['o_sum_pay'] ?></h5>
            ...
            <tbody>
              ...
              foreach ($getdetail as $row) { ?>
                <tr>
                  ...
                  <td>
                    <?php echo $row['o_month']; ?>
                  </td>
                  <td>
                    <?php echo $row['o_date_get']; ?>
                  </td>
                  <td>
                    <?php echo $row['o_get_real']; ?>
                  </td>
                  ...
                  <td align="center">
                    ...
                    <button class="btn btn-info btn-xs userinfo" data-id='<?php echo $row['o_id']; ?>'>
                      <i class="fas fa-eye">
                      </i>
                    ...
                    <button class="btn btn-warning btn-xs edit_offic" data-id='<?php echo $row['o_id']; ?>' >
                      <i class="fas fa-pencil-alt">
                      </i>
                    </button>

                    <button class="btn btn-danger btn-xs del_offic" data-id='<?php echo $row['o_id']; ?>' >
...
var o_month =[];
for(var i in x){
   result.push(x[i]['o_get_real']);
   o_sum_pay.push(x[i]['o_sum_pay']);
   o_sum_revenue.push(x[i]['o_sum_revenue']);
   o_month.push(x[i]['o_month']);
   console.log(x[i]['o_get_real']);
