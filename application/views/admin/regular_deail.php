  ...
  <div class="row">
    <div class="col">
      <div class="card">
        ...
        <?php
          foreach ($list as $row) { ?>
          <H4>:: ข้อมูลเดือนล่าสุด :: <?php echo $row['r_month'] ?></H4>
        </div>
        <br>
                ...
                <div class="row">
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <h5 class="description-header"> <?php echo $row['r_sum_revcnue'] ?></h5>
                  ...
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <h5 class="description-header"><?php echo $row['r_get_real'] ?></h5>
                  ...
                  <div class="col-sm-4">
                    <div class="description-block">
                      <h5 class="description-header"><?php echo $row['r_sum_pay'] ?></h5>
            ...
            <tbody>
              ...
              foreach ($getdetail as $row) { ?>
                <tr>
                  ...
                  <td>
                    <?php echo $row['r_month']; ?>
                  </td>
                  <td>
                    <?php echo $row['r_date_get']; ?>
                  </td>
                  <td>
                    <?php echo $row['r_get_real']; ?>
                  </td>
                  ...
                  <td align="center">
                    ...
                    <button class="btn btn-info btn-xs r_info" data-id='<?php echo $row['r_id']; ?>'>
                      <i class="fas fa-eye">
                      </i>
                    ...
                    <button class="btn btn-warning btn-xs edit_r" data-id='<?php echo $row['r_id']; ?>' >
                      <i class="fas fa-pencil-alt">
                      </i>
                    </button>

                    <button class="btn btn-danger btn-xs del_r" data-id='<?php echo $row['r_id']; ?>' >
...
<div class="modal fade" id="edit_r_id">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form id="form_r" action="" title="" method="post" >
            <div class="modal-body edit_r_show p-3">
             
            </div>
            <div class='modal-footer justify-content-between'>
            <button type='button' class='btn btn-default' data-dismiss='modal'>ยกเลิก</button>
            <button type='submit' id="btn_update" class='btn btn-primary update_r'> <i class='fas fa-save'></i> บันทึก </button>
            </div>
            </form>
          </div>
          <!-- /.modal-content -->
...
<div class="modal fade" id="model_admin_r">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
...
var o_month =[];
for(var i in x){
   result.push(x[i]['r_get_real']);
   o_sum_pay.push(x[i]['r_sum_pay']);
   o_sum_revenue.push(x[i]['r_sum_revcnue']);
   o_month.push(x[i]['r_month']);
...
$('.r_info').click(function(){
  ...
  $('.edit_r').click(function(){
    ...
    // AJAX request
    $.ajax({
     url: '../Admin/Regular/edit_r',
     type: 'post',
     data: {userid: userid},
     success: function(response){ 
      $('.edit_r_show').html(response);
       // Display Modal
       $('#edit_r_id').modal('show'); 
     }
   });
