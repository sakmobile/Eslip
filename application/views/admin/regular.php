<div class="modal fade" id="regular">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form method="post" enctype="multipart/form-data" id="add_regular" name="add_regular" action="<?= site_url('submit_regular') ?>">
        ...
        <div class="modal-body">
          <div class="container mt-3">
            ...
            <div class="form-group">
              ...
              <input type="file" class="form-control" name="rcsv_file" id="rcsv_file" required accept=".csv" />
            </div>
...
<section class="content">
  <div class="card">
    <div class="card-header card-navy card-outline">
      ...
      <div align="left">
        <a href="#">
          <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#regular"><i class="fa fa-user-plus"></i>
            เพิ่มข้อมูล
          </button>
        </a>
      </div>
             ...
             foreach ($list as $row) { ?>
              <tr>
                ...
                <td align="center">
                  ...
                  <a class="btn btn-info btn-xs" href="<?php echo site_url('show_r/'.$row['m_id']); ?>" >
                    <i class="fas fa-eye">
                    </i>
                    เลือก
                  </a>        
