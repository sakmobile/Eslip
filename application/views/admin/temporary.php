<div class="modal fade" id="modal-xl">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form method="post" enctype="multipart/form-data" id="add_e" name="add_e" action="<?= site_url('submit_e') ?>">
        ...
        <div class="modal-body">
          <div class="container mt-3">
            ...
            <div class="form-group">
              ...
              <input type="file" class="form-control" name="ecsv_file" id="ecsv_file" required accept=".csv" />
            </div>
             ...
             foreach ($list as $row) { ?>
              <tr>
                ...
                <td align="center">
                  ...
                  <a class="btn btn-info btn-xs" href="<?php echo site_url('show_t/'.$row['m_id']); ?>" >
                    <i class="fas fa-eye">
                    </i>
                    เลือก
                  </a>        
